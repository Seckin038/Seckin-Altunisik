...
// FIX: Added 'CUSTOMER_MODIFIED' to allow logging this event type.
export type TimelineEventType = 'CUSTOMER_CREATED' | 'CUSTOMER_DELETED' | 'CUSTOMER_MODIFIED' | 'SUBSCRIPTION_CREATED' | 'SUBSCRIPTION_RENEWED' | 'SUBSCRIPTION_MODIFIED' | 'SUBSCRIPTION_DELETED' | 'SUBSCRIPTION_STATUS_CHANGED' | 'REWARD_YEAR_APPLIED' | 'REWARD_GIFT_CODE_GENERATED' | 'NOTE_ADDED' | 'ACTION_REVERTED' | 'GIFT_CODE_CREATED' | 'GIFT_CODE_DELETED' | 'PAYMENT_ADDED' | 'WHATSAPP_SENT';
